...
export default function DevelopmentProcess() {
  return (
    <section id="development-process" className="bg-background">
            ...
            {processSteps.map((step, index) => (
              <div key={step.title} className="relative flex flex-col items-center text-center">
                <div className="bg-background relative">
                   <div className="flex items-center justify-center bg-secondary rounded-full h-24 w-24 border-4 border-background">
                     {step.icon}
                   </div>
                </div>
