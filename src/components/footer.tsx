    ...
    <footer className="bg-slate-950 text-slate-200 border-t border-white/10 relative overflow-hidden">
      ...
      <div className="container mx-auto py-20 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 items-start">
          ...
          <div className="flex flex-col gap-6">
            <h3 className="font-headline font-semibold text-white tracking-widest uppercase text-[11px] opacity-60 border-b border-white/10 pb-2 w-fit">{t.contactTitle}</h3>
          ...
          <div className="flex flex-col gap-6 md:items-end">
            <h3 className="font-headline font-semibold text-white tracking-widest uppercase text-[11px] opacity-60 border-b border-white/10 pb-2 w-fit">{t.followTitle}</h3>
        ...
        <div className="mt-20 pt-10 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-10">
          ...
          <div className="flex gap-10 text-[10px] font-bold uppercase tracking-[0.3em] text-slate-500">
